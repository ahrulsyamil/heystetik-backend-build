...
export declare class InterestFaceCorrectiveSkinGoalsService {
    private prisma;
    constructor(prisma: PrismaService);
    create(createInterestFaceCorrectiveSkinGoalsDto: CreateInterestFaceCorrectiveSkinGoalsDto): Promise<void>;
    ...
    update(id: number, updateInterestFaceCorrectiveSkinGoalsDto: UpdateInterestFaceCorrectiveSkinGoalsDto): Prisma.Prisma__interest_face_corrective_skin_goalsClient<import(".prisma/client").interest_face_corrective_skin_goals>;
    ...
    findAllBy(where: Prisma.interest_face_corrective_skin_goalsWhereInput): import(".prisma/client").PrismaPromise<import(".prisma/client").interest_face_corrective_skin_goals[]>;
}
